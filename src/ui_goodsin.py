...
################################################################################
## Form generated from reading UI file 'ui_goodsin.ui'
##
...
class Ui_Goods_In(object):
    def setupUi(self, Goods_In):
        if not Goods_In.objectName():
            Goods_In.setObjectName(u"Goods_In")
        Goods_In.resize(640, 480)
        Goods_In.setLocale(QLocale(QLocale.German, QLocale.Germany))
        self.verticalLayout = QVBoxLayout(Goods_In)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.fr_search = QFrame(Goods_In)
        ...
        self.fr_search_options = QFrame(Goods_In)
        ...
        self.table_articles = QTableView(Goods_In)
        ...
        self.retranslateUi(Goods_In)

        QMetaObject.connectSlotsByName(Goods_In)
    # setupUi

    def retranslateUi(self, Goods_In):
        Goods_In.setWindowTitle(QCoreApplication.translate("Goods_In", u"Wareneingang", None))
        self.cb_search.setItemText(0, QCoreApplication.translate("Goods_In", u"Bezeichnung", None))
        self.cb_search.setItemText(1, QCoreApplication.translate("Goods_In", u"Name", None))
        self.cb_search.setItemText(2, QCoreApplication.translate("Goods_In", u"EAN", None))

#if QT_CONFIG(tooltip)
        self.pb_search.setToolTip(QCoreApplication.translate("Goods_In", u"Artikel im Wareneingang registrieren", None))
#endif // QT_CONFIG(tooltip)
        self.pb_search.setText(QCoreApplication.translate("Goods_In", u"Registrieren", None))
        self.l_customer.setText(QCoreApplication.translate("Goods_In", u"Kunde", None))
#if QT_CONFIG(tooltip)
        self.le_customer.setToolTip("")
#endif // QT_CONFIG(tooltip)
        self.l_date_from.setText(QCoreApplication.translate("Goods_In", u"von", None))
        self.date_from.setDisplayFormat(QCoreApplication.translate("Goods_In", u"dd.MM.yyyy", None))
        self.l_date_to.setText(QCoreApplication.translate("Goods_In", u"bis", None))
        self.date_to.setDisplayFormat(QCoreApplication.translate("Goods_In", u"dd.MM.yyyy", None))
#if QT_CONFIG(tooltip)
        self.tb_csv.setToolTip(QCoreApplication.translate("Goods_In", u"Auftragsliste als CSV exportieren", None))
#endif // QT_CONFIG(tooltip)
        self.tb_csv.setText(QCoreApplication.translate("Goods_In", u"...", None))
#if QT_CONFIG(tooltip)
        self.table_articles.setToolTip(QCoreApplication.translate("Goods_In", u"Tabelle von Artikeln", None))
#endif // QT_CONFIG(tooltip)
    # retranslateUi
